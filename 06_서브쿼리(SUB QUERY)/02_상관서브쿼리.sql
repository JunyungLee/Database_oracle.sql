...
O.BOOKID,(SELECT BOOKNAME FROM BOOK WHERE BOOKID = O.BOOKID) AS BOOK_NAME 
FROM ORDERS O ;
---출판사별 평균도서보다 비싼 도서 목록을 구하시오
...
--BOOK + 출판사별 평균도서 
SELECT * FROM BOOK B, 
(SELECT PUBLISHER, AVG(PRICE) AS AVG_PRICE FROM BOOK GROUP BY PUBLISHER) A
