...
SELECT MONTHS_BETWEEN(SYSDATE, ADD_MONTHS(SYSDATE,2)) FROM DUAL; -- -2 (앞-뒤)
...
--------------
--1일 : 86400초, 1440분
SELECT 1*60 AS "1분(초)", 60*60 AS "1시간(초)",
       24*60*60 AS "1일(초)", 24*60 AS "1일(분)" FROM DUAL;
SELECT 1*60 AS "ONE MIN" FROM DUAL;
SELECT 1*60 AS ONE FROM DUAL;
