...
SELECT '123000' + 9 FROM DUAL; --TO_CHAR(12300) + 9 : 문자열 + 숫자 : 자동형변환
SELECT '123ABC' + 9 FROM DUAL; --[오류발생]ORA-01722: invalid number

--묵시적(자동)형변환, 명시적 형변환
SELECT '123000' + 9 , TO_NUMBER('123000') + 9 FROM DUAL; --문자 -> 숫자
-----------
...
SELECT TO_CHAR(1230.5, 'L999,999,999'),TO_CHAR(1230.5, 'L000,000,000') FROM DUAL; --반올림처리 O 
...
SELECT '2023-08-09' + 1 FROM DUAL; --[오류발생]ORA-01722: invalid number
...
SELECT TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
       TO_CHAR(TRUNC(SYSDATE), 'YYYY-MM-DD HH24:MI:SS'), --소수점 이하 TRUNC 처리 
       TO_CHAR(SYSDATE, 'YYYY-MM-DD') -- 년-월-일만 가지고 사용
FROM DUAL;
