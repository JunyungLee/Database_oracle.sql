...
*/
SELECT LAST_NAME||' '|| FIRST_NAME AS NAME, SALARY FROM EMPLOYEES WHERE SALARY >=7000 AND SALARY <= 10000
ORDER BY SALARY;
...
SELECT LAST_NAME||' '|| FIRST_NAME AS NAME, SALARY, JOB_ID, COMMISSION_PCT FROM EMPLOYEES
...
*/  
SELECT EMPLOYEE_ID, LAST_NAME||' '||FIRST_NAME AS NAME, SALARY,ROUND(SALARY * 1.123) AS INCREASE_SALARY
...
*/
SELECT INITCAP(FIRST_NAME) AS FIRST_NAME, INITCAP(LAST_NAME) AS LAST_NAME, UPPER(JOB_ID) AS Employee_JOBs 
...
CASE WHEN COMMISSION_PCT IS NOT NULL THEN 'SALARY + COMMISSION' ELSE 'SALARY ONLY' END AS SALARY_EXIST,
CASE WHEN COMMISSION_PCT IS NOT NULL THEN SALARY + (SALARY * COMMISSION_PCT) ELSE SALARY END AS SALARY
FROM EMPLOYEES
...
SELECT 'HR-COMPANY' AS COMPANY_NAME, E.LAST_NAME||' '||E.FIRST_NAME AS NAME,D.DEPARTMENT_NAME ,E.JOB_ID, L.CITY 
...
SELECT E.LAST_NAME||' '|| E.FIRST_NAME AS NAME, E.JOB_ID, D.DEPARTMENT_NAME, E.HIRE_DATE, E.SALARY
FROM EMPLOYEES E JOIN DEPARTMENTS D ON E.DEPARTMENT_ID = D.DEPARTMENT_ID;
--JOIN JOB_GRADES;
SELECT E.LAST_NAME||' '|| E.FIRST_NAME AS NAME, E.JOB_ID, D.DEPARTMENT_NAME, E.HIRE_DATE, E.SALARY, J.GRADE_LEVEL 
